      ...
      <div className="transcriptions">
         <div className="container-fluid hero2">
            ...
            <div className="hero2-text">
               <h3 className="ht2">lorem ipsum dolor sit amet, consectetur adipiscing</h3>
            </div>
         ...
         <div className="container-sm song-list mt-5">
            <table className="table">
               ...
               <tbody>
                  ...
                  <tr className="text-center">
                     <td>2</td>
                     <td>Ikaw Lamang (male key)</td>
                     <td>Princess Sevillena</td>
                     <td>Secular</td>
                     <td>P250</td>
                     <td className="actions">
                        <button type="button" className="btn btn-default">
                  ...
                  <tr className="text-center">
                     <td>7</td>
                     <td>Lupang Hinirang (Philippine National Anthem)</td>
                     <td>Julian Felipe</td>
                     <td>Secular</td>
                     <td>P250</td>
                     <td className="actions">
